...
Tags: colorbox video gallery, fancybox, flickr, gallery, instagram Gallery, jquery, picasa, prettyphoto, shortcode, slideshow, swipebox, zenfolio,
...
**Youtube channel link** - [Juna-IT Gallery Video Demonstration](https://www.youtube.com/watch?v=JyCDzjVivXU)
...
### Juna-IT Video Gallery Demonstration
...
So We are sure your video will always satisfy you. Each of the versions are made by specific style according to your preference and corresponding to your website. Gallery plugin is a real miracle.

The product includes plugin for adding video to posts and pages, as well as multiple widgets. Completely gallery plugin use shortcodes to embed slideshows in your website.
...
* **Shortcodes using Juna-IT** - Shortcode - Here you will see shotrcode which you can copy and Paste [Juna_IT_Video_Gallery id="x"] where you want to see. You can publish gallery in any Page or Post in your WordPress sites.
...
* **Vimeo Posts** - Create the gallery from Vimeo post. Collect the most entertaining and amazing videos in your gallery, make your website attractive with gallery plugin.
...
> * Select the plugin zip file (Gallery-Video-Responsive.x.x.x.zip) from your computer then click the Install Now button
...
> ### Or Mac Users
>
> * Go to your Downloads folder and locate the folder with the Juna-IT-gallery-video plugin
...
> * Click "Activate Plugin" button for activating the gallery plugin
...
If you make a purchase and does not receive Juna-IT-gallery-video.zip file or file was corrupt, contact us via this email [junait.com@gmail.com.] (mailto:junait.com@gmail.com). Send us “Order Number” of the gallery plugin, we will check and send you the zip file .
...
After installation of the pro version of the plugin, all your changes will be saved in General Options. If you still see "free version" notification after the installation of the pro version of gallery plugin, in this case:
...
>[3. Thumbnails View - Demo Version](http://juna-it.com/index.php/gallery-video-thumbnails-gallery-video-responsive/)
>
>[4. Slider - Demo Version](http://juna-it.com/index.php/gallery-video-slider-gallery-video-responsive/)
>
>[5 Carousel - Demo Version](http://juna-it.com/index.php/gallery-video-carousel-gallery-video-responsive/)
>
>[6 Polaroids - Demo Version](http://juna-it.com/index.php/gallery-video-polaroid-gallery-video-responsive/)
